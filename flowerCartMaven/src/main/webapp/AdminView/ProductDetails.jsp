                    ...
                    <table id="datatable-buttons" class="table table-hover table-striped table-bordered">
                        ...
                        <c:forEach var="product" items="${products}">
                            <tr>
                                ...
                                <td class=" last"><a class="btn btn-block" onclick="location.href = '${pageContext.request.contextPath}/DeleteProductServlet?ID=' + $(this).parents('tr').find('td:eq(0)').html();$(this).parents('tr').remove();">
